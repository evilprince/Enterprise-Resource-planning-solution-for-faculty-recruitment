...
//@@@@@@@@@ address for the image and signature

$image_address="http://iitbhu.ac.in/rolling/uploads/$email/image$email";
$signature_address="http://iitbhu.ac.in/rolling/uploads/$email/signature$email";
...
.header{background-color: #fff;float:center;box-shadow:3px 3px 0px 0px; position:relative;}
.toptitle{font-weight: bold;color: #751E1E;font-size: 15pt;text-align:center;float:right;padding-right:190pt;}
.general_information{background-color:#fff;box-shadow:2px 2px 0px 0px;position:relative;}
...
.pdf_background {border:solid 2px black; background-color:green;position:fixed;}
</style>
</head>
<body>
<div class='pdf_background'>
<form action='science_pdf.php' ecntype='multipart/form-data' method='POST'>
<div class='header'>
...
<div id='image'><img src=".$image_address."/></div>
...
<label class='arrange_text'>".$rows['present_present_designation']."</label>
</p>
...
<tr>
<td><label class='arrange_text'>".$rows['research_publications_books _author']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_books _title']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_books _editor']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_books _publisher']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_books _pages']."</label></td>
<td><label class='arrange_text'>".$rows['research_publications_books _ISSN']."</label></td>
</tr>
</table>
...
<tr>
<td><label class='arrange_text'>".$rows['other_projects_ tile']."</label></td>
<td><label class='arrange_text'>".$rows['other_projects_ total_amount']."</label></td>
<td><label class='arrange_text'>".$rows['other_projects_ funding_agency']."</label></td>
<td><label class='arrange_text'>".$rows['other_projects_ duration']."</label></td>
<td><label class='arrange_text'>".$rows['other_projects_ current_status']."</label></td>
</tr>
</table>
...
<label class='arrange_text'>".$rows['details_ administration']."</label>
</p>
...
<label class='arrange_text'>".$rows['details_ work_done']."</label></p>

<p><h3>A brief statement on your philosophy about teaching (Maximum 500 words):</h3>
<label class='arrange_text'>".$rows['details_ philosophy']."</label></p>
...
<label class='arrange_text'>".$rows['details_ proposed_research']."</label></p>

<p><h3>Extracurricular interests:</h3>
<label class='arrange_text'>".$rows['details_ extracurricularr']."</label></p>
...
<label class='arrange_text'>".$rows['convict_details']."</label></p>
...
<p>date:<label class='arrange_text'>".$rows['registration_date']."</label></td> <br/>
Place:<label class='arrange_text'>".$rows['registration_place']."</label></td></p>
<p align='center'><br/>(Signature of the Applicant)
<div id='signatur_box'>
<img src=".$signature_address."/>
</div>
</p>
...
<hr/>
<div id='next_previous'><input type='submit' name='submit' id='submit' value='Generate pdf'/>
</div>
</form>
</div>
</body>";
